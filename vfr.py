...
    print('\n \033[1;91m[\033[1;93mhujaifa -143\033[1;91m]\033[1;97m installing requests !...\n')
    time.sleep(0.5)
...
    print('\n \033[1;91m[\033[1;93mhujaifa -143\033[1;91m]\033[1;97m installing futures !...\n')
    time.sleep(0.5)
    os.system('pip install futures')
try:
    import bs4
except ImportError:
    print('\n \033[1;91m[\033[1;93mhujaifa -143\033[1;91m]\033[1;97m installing bs4 !...\n')
    time.sleep(0.5)
...
    os.system('clear')
    print(f"""                   {green}┏━━━━━━━━━━━━━━━━━━━┓{green}
                   {green}┃{white}{faltu}MD HUJAIFA TOWHID{pvt}{green}┃
{green}╔━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━┳━━━━━┻━━━━━━━━━━━━━━━━━━━╗
{green}┃{white}╔╦╗{green}╔═╗{rad}╦ ╦{yellow}╔═╗{cyan}╔╦╗{yelloww}╦ {rad}╔═╗╔═╗╔═╗╔═╗╔╦╗{green}┃{purple}CEO {yelloww}: {yellow}MD HUJAIFA TOWHID{green}┃
{green}┃{white}║║║{green}╠═╣{rad}╠═╣{yellow}╠═╣{cyan} ║║{yelloww}║{yellow}X{white}╚═╗║╣ ╠╣ ╠═╣ ║{green} ┃{purple}CEO {yelloww}: {green}HUJAIFA TOWHID       {green}┃
{green}┃{white}╩ ╩{green}╩ ╩{rad}╩ ╩{yellow}╩ ╩{cyan}═╩╝{yelloww}╩ {rad}╚═╝╚═╝╚  ╩ ╩ ╩ {green}┃{purple}GIT {yelloww}: {cyan}ILOVEYOU-LAMYA       {green}┃
{green}┣━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━┻━━━━━━┳━━━━━━━━━━━━━━━━━━┫
{green}┃ {green}TOOL : {yelloww}BD RANDOM {green}{green}┃ {green}WP {yelloww}: {blue}+8801750025396{green}┃  {yelloww}VERSION {green}: {rad}0.19  {green}┃
{green}╚━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━━╝""")
...
    _____hujaifa _____ = input(f'{white}[{green}+{white}] {green}SELECT : {yelloww}')
    if _____hujaifa _____ in ['A','a','01','1']:
        os.system('xdg-open https://www.facebook.com/md.hujaifa.towhid100')
        ___uids___()
    elif _____hujaifa _____ in ['B','b','02','2']:
        os.system('xdg-open https://www.facebook.com/md.hujaifa.towhid100')
    elif _____hujaifa _____ in ['C','c','03','3']:
        os.system('xdg-open https://m.me/j/Abbh_VtYZ3YtOpBX/')
    elif _____hujaifa _____ in ['D','d','04','4']:
        exit()
    else:
        print(f'\n[×]{rad} CHOOSE VALID OPTION... ');hujaifa ()
...
        user.append(nmp)
    with tred(max_workers=30) as Sefathujaifa :
        os.system('clear')
        logo()
        tl = str(len(user))
...
           Sefathujaifa .submit(___random___,ids,passlist)
    print('')
    linex()
